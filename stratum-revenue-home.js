...
(() => {
  ...
  const copy={
    en:{
      ...
      step3Badge:'PROFESSIONAL',step3Title:'Get a workflow decision',step3Text:'For one recurring workflow with material cost, delay or coordination burden. Fixed scope, asynchronous by default.',step3Meta1:'1 workflow',step3Meta2:'3-business-day target',step3Cta:'Review Workflow Audit — $499',
      ...
      receiveLabel:'WHAT THE WORKFLOW AUDIT TURNS INTO',receiveTitle:'Decision artifacts your team can actually use.',receiveNote:'The high-value offer is deliberately concrete: map the workflow, expose leaks, rank choices, define controls, then decide what happens next.',
      ...
      finalLabel:'TURN SIGNALS INTO A DECISION',finalTitle:'Do not buy more AI until you know what the next dollar is supposed to do.',finalText:'Start free if the problem is still fuzzy. Choose the smallest paid route when the evidence is enough. If specialist review is needed, choose workflow or spend by the decision—not by the price.',finalCta:'Start with free evidence',
    ...
    ja:{
      ...
      step3Badge:'PROFESSIONAL',step3Title:'Workflowの書面判断を得る',step3Text:'コスト・遅延・調整負荷が大きい定常Workflow 1件を、固定範囲で専門分析。基本は非同期です。',step3Meta1:'1 Workflow',step3Meta2:'3営業日目安',step3Cta:'Workflow Auditを見る — $499',
      ...
      receiveLabel:'WORKFLOW AUDITで得られるもの',receiveTitle:'チームが実際に使えるDecision Artifact。',receiveNote:'Workflowを可視化し、漏れを出し、選択肢を順位化し、Controlを決め、次に何をするかまで落とします。',
      ...
      finalLabel:'SIGNALを判断へ',finalTitle:'次の1ドルの役割が分かるまで、AIを増やさない。',finalText:'課題が曖昧なら無料から。Evidenceが十分なら最小のPaid Routeへ。専門監査が必要なら、価格ではなく「WorkflowかSpendか」で選びます。',finalCta:'無料Evidenceから始める',
    ...
    es:{
      ...
      receiveLabel:'QUÉ PRODUCE WORKFLOW AUDIT',receiveTitle:'Artefactos de decisión que el equipo puede usar.',receiveNote:'Mapea el workflow, expone fugas, ordena opciones, define controles y decide qué ocurre después.',d1:'Mapa de Workflow',d1n:'Trigger, responsables, sistemas y handoffs.',d2:'Análisis de fugas',d2n:'Retrabajo, retraso y pérdida de valor.',d3:'Oportunidades ordenadas',d3n:'Impacto, esfuerzo, reversibilidad y riesgo.',d4:'Escenarios ROI',d4n:'Supuestos transparentes.',d5:'Puntos humanos',d5n:'Dónde mantener autoridad y revisión.',d6:'Plan 30 días',d6n:'Probar, validar, escalar, rediseñar o parar.',
      finalLabel:'DE SEÑAL A DECISIÓN',finalTitle:'No compres más AI hasta saber qué debe hacer el próximo dólar.',finalText:'Empieza gratis si el problema sigue difuso. Elige la ruta pagada mínima cuando haya evidencia. Si hace falta revisión especialista, elige workflow o gasto según la decisión.',finalCta:'Empezar con evidencia gratis',
