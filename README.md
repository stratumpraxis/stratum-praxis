...
- [Cross-Agent Operating Kit · Personal $69 one-time](https://stratumpraxis.com/cross-agent-operating-kit.html?utm_source=github&utm_medium=referral&utm_campaign=github_cross_agent_winner&utm_content=readme_entry&route_id=github_readme_entry_cross_agent_20260913) — portable operating controls for teams that work across multiple AI runtimes. Review the 13 editable files, license scope, Stripe checkout details and verified delivery path before purchase.
