(function () {
  ...
  const T = {
    ...
    headline_1: { en:'One operating policy.', ja:'運用ポリシーは1つ。', ko:'운영 정책은 하나.', zh:'一套运营策略。' },
    headline_2: { en:'Multiple AI agents.', ja:'複数のAI Agentで使う。', ko:'여러 AI 에이전트에서 사용.', zh:'用于多个 AI Agent。' },
    headline_3: { en:'No rebuild every switch.', ja:'切替のたびに作り直さない。', ko:'전환할 때마다 다시 만들지 않습니다.', zh:'切换时无需重建。' },
    purpose: { en:'Master policy + human gates + cost guards + state handoff.', ja:'Master Policy + Human Gate + Cost Guard + State Handoff。', ko:'Master Policy + Human Gate + Cost Guard + State Handoff.', zh:'Master Policy + Human Gate + Cost Guard + State Handoff。' },
    lead: { en:'Use one editable operating kit across Claude Code, Codex and Cursor so permissions, stop conditions, budgets and handoff state do not disappear when the agent changes.', ja:'Claude Code・Codex・Cursorを1つの編集可能な運用キットでつなぎ、権限・停止条件・予算・引継ぎ状態をAgent切替後も残します。', ko:'Claude Code, Codex, Cursor를 하나의 편집 가능한 운영 키트로 연결해 권한, 중지 조건, 예산, 인계 상태를 에이전트 전환 후에도 유지합니다.', zh:'用一套可编辑运营套件连接 Claude Code、Codex 与 Cursor，在切换 Agent 后仍保留权限、停止条件、预算和交接状态。' },
    choose_license: { en:'Get Personal Kit · $69', ja:'Personal Kitを購入 · $69', ko:'Personal Kit 구매 · $69', zh:'购买 Personal Kit · $69' },
